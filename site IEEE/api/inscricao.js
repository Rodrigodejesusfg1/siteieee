...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (!data.nome || !data.email || !data.telefone || !data.faculdade || !data.curso || !data.ingresso) {
    ...
    const { data: result, error } = await supabase.from('inscricoes').insert(insertData).select();
